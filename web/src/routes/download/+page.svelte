  ...
  <div class="download-page">
    ...
    <div class="download-grid">
      <section class="download-card">
        ...
        <p>Apple silicon and Intel</p>
        <a class="download-button" href={`${latestDownloadUrl}/Chromazen.dmg`}>
          Download .dmg
        </a>
      </section>
      <section class="download-card">
        <details class="download-info">
          <summary aria-label="Information about the Windows download">
            <h2>
          ...
          <p>Windows may show a security warning because the app isn’t signed yet.</p>
        </details>
        <p>64-bit Windows</p>
      ...
      <section class="download-card">
        <details class="download-info">
          <summary aria-label="Information about the Linux download">
            <h2>
              <svg class="linux-icon" viewBox="0 0 448 512" aria-hidden="true">
          ...
          <p>Right-click the file, open <strong>Properties → Permissions</strong>, and allow it to run as a program.</p>
        </details>
        <p>64-bit Linux</p>
        <a class="download-button" href={`${latestDownloadUrl}/Chromazen-linux-x86_64.AppImage`}>
          Download AppImage
        </a>
      </section>
    </div>
