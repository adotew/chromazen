/* @ts-self-types="./chromazen_web.d.ts" */

export class WebCanvas {
    static __wrap(ptr) {
        const obj = Object.create(WebCanvas.prototype);
        obj.__wbg_ptr = ptr;
        WebCanvasFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebCanvasFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webcanvas_free(ptr, 0);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     * @returns {boolean}
     */
    beginStroke(x, y, pressure, time_ms) {
        const ret = wasm.webcanvas_beginStroke(this.__wbg_ptr, x, y, pressure, time_ms);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    clear() {
        const ret = wasm.webcanvas_clear(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    endStroke() {
        const ret = wasm.webcanvas_endStroke(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    panBy(delta_x, delta_y) {
        const ret = wasm.webcanvas_panBy(this.__wbg_ptr, delta_x, delta_y);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    pushStrokeSamples(samples) {
        const ptr0 = passArrayF32ToWasm0(samples, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webcanvas_pushStrokeSamples(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    redo() {
        const ret = wasm.webcanvas_redo(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    render() {
        const ret = wasm.webcanvas_render(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} width
    ...
    resize(width, height, scale) {
        wasm.webcanvas_resize(this.__wbg_ptr, width, height, scale);
    }
    /**
     * @param {number} size
     */
    setBrushSize(size) {
        wasm.webcanvas_setBrushSize(this.__wbg_ptr, size);
    }
    /**
     * @param {number} red
     * @param {number} green
    ...
    setColor(red, green, blue) {
        wasm.webcanvas_setColor(this.__wbg_ptr, red, green, blue);
    }
    /**
     * @param {number} tool
     */
    setTool(tool) {
        const ret = wasm.webcanvas_setTool(this.__wbg_ptr, tool);
        if (ret[1]) {
     ...
     */
    undo() {
        const ret = wasm.webcanvas_undo(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} factor
     ...
     */
    zoomAt(factor, x, y) {
        const ret = wasm.webcanvas_zoomAt(this.__wbg_ptr, factor, x, y);
        return ret !== 0;
    }
}
if (Symbol.dispose) WebCanvas.prototype[Symbol.dispose] = WebCanvas.prototype.free;
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h443b382ee22a5c11(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_webcanvas_new: function(arg0) {
            const ret = WebCanvas.__wrap(arg0);
            return ret;
        },
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h61d099fbc74d6f11);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h09894e96c6d9a5b6);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./chromazen_web_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h61d099fbc74d6f11(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h61d099fbc74d6f11(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h09894e96c6d9a5b6(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h09894e96c6d9a5b6(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h443b382ee22a5c11(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h443b382ee22a5c11(arg0, arg1, arg2, arg3);
}
...
const WebCanvasFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webcanvas_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chromazen_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
